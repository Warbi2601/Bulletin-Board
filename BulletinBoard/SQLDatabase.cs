...
namespace SQLDatabase
{
    public class DatabaseRow
    {
        ...
        {
            if (Fields.Keys.Contains(column_name))
            {
    ...
    public class User : DatabaseRow
    {
        public User(DatabaseRow r)
        {
    ...
    public class DatabaseTable
    {
        ...
        /// <summary> return the next ID number in the sequence, so it can be used to insert new rows. Assumes that the table has an integer field called 'ID'.
        /// </summary>
